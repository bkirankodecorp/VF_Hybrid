...
public class LTL_TW_Quote_Seller_Response_Ranking_Basis_Per_Gal {
	...
	public void setUp(){
		...
		htmlReporter= new ExtentHtmlReporter(path + "/LTL Tankwagon/LTL_Seller_Response_Ranking_Basis_$_Per_Gal.html");
