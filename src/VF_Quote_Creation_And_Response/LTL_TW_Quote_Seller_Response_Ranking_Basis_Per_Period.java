...
public class LTL_TW_Quote_Seller_Response_Ranking_Basis_Per_Period {
	...
	public void Open_Browser() throws Exception {
		...
		ExcelUtils.setExcelFile(Constant.path + Constant.pathtest,"VF_LTL_TW_Seller_Response");
	...
	public  void Verify_finaltotal_and_RankingBasis_Values() throws Exception{
		...
		try {
			...
			System.out.println("Final Total has value as " + numberAsString);
			test1.info("Final Total has value as " + numberAsString);

			ExcelUtils.setCellData(numberAsString, 70, colnum);
